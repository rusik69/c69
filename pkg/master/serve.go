...
func Serve() {
	...
	r.GET("/api/v1/vm/start/:name", StartVMHandler)
	r.GET("/api/v1/vm/stop/:name", StopVMHandler)
	...
	r.GET("/api/v1/container/start/:name", StartContainerHandler)
	r.GET("/api/v1/container/stop/:name", StopContainerHandler)
